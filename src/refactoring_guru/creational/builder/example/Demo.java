package refactoring_guru.creational.builder.example;

import refactoring_guru.creational.builder.example.builders.CarBuilder;
import refactoring_guru.creational.builder.example.builders.CarManualBuilder;
import refactoring_guru.creational.builder.example.cars.Car;
import refactoring_guru.creational.builder.example.cars.Manual;
import refactoring_guru.creational.builder.example.director.Director;
