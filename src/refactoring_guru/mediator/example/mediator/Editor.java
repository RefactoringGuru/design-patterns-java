...
import refactoring_guru.mediator.example.components.InitList;
...
public class Editor implements Mediator {
  ...
  public void registerComponent(Component component) {
    ...
    switch (component.getName()) {
      ...
      case "List" -> list = (InitList) component;  // assign the component to list
      case "SaveButton" -> save = (SaveButton) component;
      case "TextBox" -> textBox = (TextBox) component;
      case "Title" -> title = (Title) component;
      default -> Logger.getLogger(Editor.class.getName())
              .log(Level.WARNING, () -> "Unknown component: " + component.getName());
    }
  ...
  @Override
  public void setElementsList(ListModel<Note> list) {
